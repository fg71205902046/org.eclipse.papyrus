 ...
 * @generated
 */
public class ProjectRulesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ProjectRulesPackage.EXTENSION_ELEMENT: {
			...
			if (result == null) {
				result = caseExtensionModelNode(extensionElement);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ProjectRulesPackage.EXTENSION_MODEL_NODE: {
			ExtensionModelNode extensionModelNode = (ExtensionModelNode) theEObject;
			T result = caseExtensionModelNode(extensionModelNode);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
		...
		case ProjectRulesPackage.EXTENSION_ATTRIBUTE: {
			...
			if (result == null) {
				result = caseExtensionModelNode(extensionAttribute);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ProjectRulesPackage.VALUE: {
		...
		case ProjectRulesPackage.LITERAL_STRING: {
			...
			if (result == null) {
				result = caseValue(literalString);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ProjectRulesPackage.OPAQUE_VALUE: {
			OpaqueValue opaqueValue = (OpaqueValue) theEObject;
			T result = caseOpaqueValue(opaqueValue);
			if (result == null) {
				result = caseValue(opaqueValue);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Extension Model Node</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @param object
	 *                   the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Extension Model Node</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExtensionModelNode(ExtensionModelNode object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Opaque Value</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 ...
	 * @param object
	 *                   the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Opaque Value</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOpaqueValue(OpaqueValue object) {
		return null;
	}
