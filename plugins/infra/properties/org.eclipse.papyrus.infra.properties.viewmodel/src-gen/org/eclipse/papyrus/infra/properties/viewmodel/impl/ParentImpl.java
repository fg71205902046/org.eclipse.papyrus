 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.infra.properties.viewmodel.impl.ParentImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ParentImpl extends UIElementImpl implements Parent {
	/**
	...
	protected EClass eStaticClass() {
		return ViewmodelPackage.Literals.PARENT;
	}
	...
	public EList<UIElement> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<UIElement>(UIElement.class, this, ViewmodelPackage.PARENT__CHILDREN);
		}
		return children;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ViewmodelPackage.PARENT__CHILDREN:
