	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ViewmodelPackage.VIEW_MODEL: {
				...
				if (result == null) result = caseParent(viewModel);
				if (result == null) result = caseUIElement(viewModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.PARENT: {
				Parent parent = (Parent)theEObject;
				T result = caseParent(parent);
				if (result == null) result = caseUIElement(parent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.UI_ELEMENT: {
				UIElement uiElement = (UIElement)theEObject;
				T result = caseUIElement(uiElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.PROPERTY: {
				Property property = (Property)theEObject;
				T result = caseProperty(property);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.CONTROL: {
			...
			case ViewmodelPackage.VERTICAL_LAYOUT: {
				VerticalLayout verticalLayout = (VerticalLayout)theEObject;
				T result = caseVerticalLayout(verticalLayout);
				if (result == null) result = caseParent(verticalLayout);
				if (result == null) result = caseUIElement(verticalLayout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ViewmodelPackage.GRID_LAYOUT: {
				GridLayout gridLayout = (GridLayout)theEObject;
				T result = caseGridLayout(gridLayout);
				if (result == null) result = caseParent(gridLayout);
				if (result == null) result = caseUIElement(gridLayout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
