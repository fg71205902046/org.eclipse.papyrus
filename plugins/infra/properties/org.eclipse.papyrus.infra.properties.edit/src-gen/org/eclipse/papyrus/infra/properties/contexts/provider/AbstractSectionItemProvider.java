...
public class AbstractSectionItemProvider extends DisplayUnitItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractSection_name_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractSection_name_feature", "_UI_AbstractSection_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addTabPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AbstractSection_tab_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_AbstractSection_tab_feature", "_UI_AbstractSection_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractSection_type") : //$NON-NLS-1$
			getString("_UI_AbstractSection_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
