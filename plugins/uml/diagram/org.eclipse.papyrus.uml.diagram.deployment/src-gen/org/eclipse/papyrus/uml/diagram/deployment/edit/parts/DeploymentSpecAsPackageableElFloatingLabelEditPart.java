...
public class DeploymentSpecAsPackageableElFloatingLabelEditPart extends FloatingLabelEditPart
	 ...
	 * @generated
	 */
	public DeploymentSpecAsPackageableElFloatingLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DeploymentSpecAsPackageableElFloatingLabelEditPart.this), (String) value));
									}
								});
