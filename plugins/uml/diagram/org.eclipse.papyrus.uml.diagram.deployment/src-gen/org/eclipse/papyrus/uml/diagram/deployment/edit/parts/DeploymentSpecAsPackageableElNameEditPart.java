...
public class DeploymentSpecAsPackageableElNameEditPart extends PapyrusCompartmentEditPart
	 ...
	 * @generated
	 */
	public DeploymentSpecAsPackageableElNameEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DeploymentSpecAsPackageableElNameEditPart.this), (String) value));
									}
								});
