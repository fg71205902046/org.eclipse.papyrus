...
public class DeploymentSpecAsNestedArtifactFloatingLabelEditPart extends FloatingLabelEditPart
	 ...
	 * @generated
	 */
	public DeploymentSpecAsNestedArtifactFloatingLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DeploymentSpecAsNestedArtifactFloatingLabelEditPart.this), (String) value));
									}
								});
