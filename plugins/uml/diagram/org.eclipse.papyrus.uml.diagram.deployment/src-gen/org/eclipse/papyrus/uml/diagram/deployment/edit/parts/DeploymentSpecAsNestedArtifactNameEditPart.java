...
public class DeploymentSpecAsNestedArtifactNameEditPart extends PapyrusCompartmentEditPart
	 ...
	 * @generated
	 */
	public DeploymentSpecAsNestedArtifactNameEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DeploymentSpecAsNestedArtifactNameEditPart.this), (String) value));
									}
								});
