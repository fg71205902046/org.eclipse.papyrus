...
public class DeploymentSpecAsClassifierFloatingLabelEditPart extends FloatingLabelEditPart
	 ...
	 * @generated
	 */
	public DeploymentSpecAsClassifierFloatingLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DeploymentSpecAsClassifierFloatingLabelEditPart.this), (String) value));
									}
								});
