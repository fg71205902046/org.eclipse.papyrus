 ...
 * @generated
 */
public class CollaborationUseFloatingLabelEditPartCN extends FloatingLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "CollaborationUse_FloatingNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), CollaborationUseFloatingLabelEditPartCN.this), (String) value));
									}
								});
