 ...
 * @generated
 */
public class TimeConstraintSpecificationEditPartCN extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "TimeConstraint_BodyLabel_CN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), TimeConstraintSpecificationEditPartCN.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.TimeConstraint_Shape_CN, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
