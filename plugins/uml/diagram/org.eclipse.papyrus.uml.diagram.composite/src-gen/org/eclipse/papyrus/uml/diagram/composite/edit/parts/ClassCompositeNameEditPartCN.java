 ...
 * @generated
 */
public class ClassCompositeNameEditPartCN extends PapyrusCompartmentEditPart
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ClassCompositeNameEditPartCN.this), (String) value));
									}
								});
