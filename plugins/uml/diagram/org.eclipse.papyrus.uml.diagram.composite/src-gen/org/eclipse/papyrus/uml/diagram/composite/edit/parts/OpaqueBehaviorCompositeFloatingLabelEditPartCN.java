 ...
 * @generated
 */
public class OpaqueBehaviorCompositeFloatingLabelEditPartCN extends FloatingLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "OpaqueBehavior_FloatingNameLabel_CN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OpaqueBehaviorCompositeFloatingLabelEditPartCN.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.OpaqueBehavior_Shape_CN, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
