 ...
 * @generated
 */
public class InteractionCompositeFloatingLabelEditPart extends FloatingLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Interaction_FloatingNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InteractionCompositeFloatingLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Interaction_Shape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
