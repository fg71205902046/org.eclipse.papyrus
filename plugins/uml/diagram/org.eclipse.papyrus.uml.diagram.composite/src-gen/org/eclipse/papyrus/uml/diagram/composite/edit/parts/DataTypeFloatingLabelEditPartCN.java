 ...
 * @generated
 */
public class DataTypeFloatingLabelEditPartCN extends FloatingLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "DataType_FloatingNameLabel_CN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DataTypeFloatingLabelEditPartCN.this), (String) value));
									}
								});
