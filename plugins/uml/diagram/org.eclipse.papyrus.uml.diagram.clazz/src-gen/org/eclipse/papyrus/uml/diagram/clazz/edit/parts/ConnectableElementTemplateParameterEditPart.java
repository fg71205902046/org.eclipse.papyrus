 ...
 * @generated
 */
public class ConnectableElementTemplateParameterEditPart extends CompartmentEditPart
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ConnectableElementTemplateParameterEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ConnectableElementTemplateParameter_TemplateParameterLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
