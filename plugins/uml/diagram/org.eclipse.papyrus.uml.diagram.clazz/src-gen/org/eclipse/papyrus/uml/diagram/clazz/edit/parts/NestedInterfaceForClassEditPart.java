 ...
 * @generated
 */
public class NestedInterfaceForClassEditPart extends UMLCompartmentEditPart
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedInterfaceForClassEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Interface_ClassNestedClassifierLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
