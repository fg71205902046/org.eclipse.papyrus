 ...
 * @generated
 */
public class NestedComponentForInterfaceEditPart extends UMLCompartmentEditPart
		implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Component_InterfaceNestedClassifierLabel";
	 ...
	 * @generated
	 */
	public NestedComponentForInterfaceEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedComponentForInterfaceEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Component_InterfaceNestedClassifierLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
