 ...
 * @generated
 */
public class NestedPrimitiveTypeForComponentEditPart extends UMLCompartmentEditPart
		implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "PrimitiveType_ComponentNestedClassifierLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedPrimitiveTypeForComponentEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.PrimitiveType_ComponentNestedClassifierLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
