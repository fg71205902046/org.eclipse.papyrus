 ...
 * @generated
 */
public class NestedDataTypeForClassEditPart extends UMLCompartmentEditPart
		implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "DataType_ClassNestedClassifierLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedDataTypeForClassEditPart.this), (String) value));
									}
								});
