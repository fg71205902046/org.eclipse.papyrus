 ...
 * @generated
 */
public class BindingSubstitutionEditPart extends PapyrusLabelEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(TemplateBindingDisplayEditPolicy.TEMPLATE_PARAMETER_DISPLAY,
				new TemplateBindingDisplayEditPolicy());
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), BindingSubstitutionEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.TemplateBinding_Edge, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
