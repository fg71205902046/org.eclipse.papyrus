 ...
 * @generated
 */
public class TargetISLinkLabelEditPart extends PapyrusLabelEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(InstanceSpecificationRoleDisplayEditPolicy.INSTANCE_SPECIFICATION_ROLE_DISPLAY,
				new ISRoleTargetDisplayEditPolicy());
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), TargetISLinkLabelEditPart.this), (String) value));
									}
								});
