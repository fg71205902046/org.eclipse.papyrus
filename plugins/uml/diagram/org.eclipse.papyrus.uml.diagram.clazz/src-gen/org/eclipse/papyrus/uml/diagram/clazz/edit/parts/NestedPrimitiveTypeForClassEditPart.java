 ...
 * @generated
 */
public class NestedPrimitiveTypeForClassEditPart extends UMLCompartmentEditPart
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedPrimitiveTypeForClassEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.PrimitiveType_ClassNestedClassifierLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
