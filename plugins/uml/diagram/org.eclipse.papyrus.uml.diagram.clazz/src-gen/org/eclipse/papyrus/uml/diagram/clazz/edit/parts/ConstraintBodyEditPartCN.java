...
public class ConstraintBodyEditPartCN extends PapyrusCompartmentEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "Constraint_FloatingNameLabel_CN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ConstraintBodyEditPartCN.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Constraint_PackagedElementShape_CN, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
