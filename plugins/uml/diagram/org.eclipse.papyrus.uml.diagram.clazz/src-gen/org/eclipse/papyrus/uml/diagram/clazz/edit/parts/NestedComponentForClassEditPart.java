 ...
 * @generated
 */
public class NestedComponentForClassEditPart extends UMLCompartmentEditPart
		implements ITextAwareEditPart, IPrimaryEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Component_ClassNestedClassifierLabel";
	 ...
	 * @generated
	 */
	public NestedComponentForClassEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), NestedComponentForClassEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Component_ClassNestedClassifierLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
