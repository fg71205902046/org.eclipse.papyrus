 ...
 * @generated
 */
public class SourceISLinkLabelEditPart extends PapyrusLabelEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(InstanceSpecificationRoleDisplayEditPolicy.INSTANCE_SPECIFICATION_ROLE_DISPLAY,
				new ISRoleSourceDisplayEditPolicy());
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), SourceISLinkLabelEditPart.this), (String) value));
									}
								});
