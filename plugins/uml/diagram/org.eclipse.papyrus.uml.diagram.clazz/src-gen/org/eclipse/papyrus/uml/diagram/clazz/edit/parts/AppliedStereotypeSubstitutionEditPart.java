 ...
 * @generated
 */
public class AppliedStereotypeSubstitutionEditPart extends PapyrusLabelEditPart
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), AppliedStereotypeSubstitutionEditPart.this), (String) value));
									}
								});
