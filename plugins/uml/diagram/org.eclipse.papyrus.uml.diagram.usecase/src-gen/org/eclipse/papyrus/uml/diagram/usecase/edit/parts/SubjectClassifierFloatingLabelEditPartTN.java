 ...
 * @generated
 */
public class SubjectClassifierFloatingLabelEditPartTN extends FloatingLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Classifier_FloatingNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), SubjectClassifierFloatingLabelEditPartTN.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Classifier_SubjectShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
