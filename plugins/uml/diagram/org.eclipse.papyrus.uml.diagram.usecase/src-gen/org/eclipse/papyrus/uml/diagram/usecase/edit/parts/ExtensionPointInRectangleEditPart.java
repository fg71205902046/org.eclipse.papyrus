...
public class ExtensionPointInRectangleEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ExtensionPoint_ClassifierExtensionPointLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ExtensionPointInRectangleEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ExtensionPoint_ClassifierExtensionPointLabel, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
