...
public class ActorQualifiedNameInPEditPart extends PapyrusLabelEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "Actor_QualifiedNameLabel_CN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActorQualifiedNameInPEditPart.this), (String) value));
									}
								});
