...
public class ActorQualifiedNameInCEditPart extends PapyrusLabelEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "Actor_QualifiedNameLabel_CCN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActorQualifiedNameInCEditPart.this), (String) value));
									}
								});
