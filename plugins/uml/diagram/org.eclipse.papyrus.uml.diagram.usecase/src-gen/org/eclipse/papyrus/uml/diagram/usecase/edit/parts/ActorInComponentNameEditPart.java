...
public class ActorInComponentNameEditPart extends PapyrusLabelEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "Actor_NameLabel_CCN";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActorInComponentNameEditPart.this), (String) value));
									}
								});
