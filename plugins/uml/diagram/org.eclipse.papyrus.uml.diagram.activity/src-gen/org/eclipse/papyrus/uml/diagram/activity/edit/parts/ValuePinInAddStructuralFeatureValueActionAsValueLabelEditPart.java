 ...
 * @generated
 */
public class ValuePinInAddStructuralFeatureValueActionAsValueLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_AddStructuralFeatureValueActionValueNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInAddStructuralFeatureValueActionAsValueLabelEditPart.this), (String) value));
									}
								});
