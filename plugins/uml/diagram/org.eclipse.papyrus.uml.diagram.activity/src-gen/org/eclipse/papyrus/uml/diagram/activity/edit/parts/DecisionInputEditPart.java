...
public class DecisionInputEditPart extends PapyrusLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "DecisionNode_DecisionInputLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.DecisionInputEditPart.VISUAL_ID), new Point(0, 0));
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DecisionInputEditPart.this), (String) value));
									}
								});
