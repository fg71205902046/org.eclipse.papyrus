 ...
 * @generated
 */
public class InputPinInAddStructuralFeatureValueActionAsInserAtLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_AddStructuralFeatureValueActionInsertAtNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInAddStructuralFeatureValueActionAsInserAtLabelEditPart.this), (String) value));
									}
								});
