 ...
 * @generated
 */
public class ObjectFlowAppliedStereotypeEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ObjectFlow_StereotypeLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ObjectFlowAppliedStereotypeEditPart.this), (String) value));
									}
								});
