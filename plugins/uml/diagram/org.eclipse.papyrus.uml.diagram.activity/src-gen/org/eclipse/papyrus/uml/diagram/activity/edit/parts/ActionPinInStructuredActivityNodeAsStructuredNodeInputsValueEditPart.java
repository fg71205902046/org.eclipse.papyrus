 ...
 * @generated
 */
public class ActionPinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_StructuredActivityNodeInputValueLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart.this), (String) value));
									}
								});
