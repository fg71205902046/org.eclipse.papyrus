 ...
 * @generated
 */
public class OutputPinInAddStructuralFeatureValueActionAsResultLabel3EditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "OutputPin_AddStructuralFeatureValueActionResultNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OutputPinInAddStructuralFeatureValueActionAsResultLabel3EditPart.this), (String) value));
									}
								});
