...
public class InputPinInAddStructuralFeatureValueActionAsObjectAppliedStereotypeWrappingLabelEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_AddStructuralFeatureValueActionObjectStereotypeLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInAddStructuralFeatureValueActionAsObjectAppliedStereotypeWrappingLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_AddStructuralFeatureValueActionObjectShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
