 ...
 * @generated
 */
public class IntervalConstraintAsLocalPostcondNameEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "IntervalConstraint_LocalPostconditionNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), IntervalConstraintAsLocalPostcondNameEditPart.this), (String) value));
									}
								});
