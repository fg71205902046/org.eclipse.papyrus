 ...
 * @generated
 */
public class DurationConstraintAsLocalPrecondBodyEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "DurationConstraint_LocalPreconditionBodyLabel";
	 ...
	 * @generated
	 */
	public DurationConstraintAsLocalPrecondBodyEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DurationConstraintAsLocalPrecondBodyEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.DurationConstraint_LocalPreconditionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
