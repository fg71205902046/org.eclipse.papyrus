 ...
 * @generated
 */
public class ControlFlowGuardEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ControlFlow_GuardLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ControlFlowGuardEditPart.this), (String) value));
									}
								});
