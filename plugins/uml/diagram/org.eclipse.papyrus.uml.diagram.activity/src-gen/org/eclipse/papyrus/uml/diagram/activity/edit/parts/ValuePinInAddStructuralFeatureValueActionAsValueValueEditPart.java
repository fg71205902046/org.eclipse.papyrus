 ...
 * @generated
 */
public class ValuePinInAddStructuralFeatureValueActionAsValueValueEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_AddStructuralFeatureValueActionValueValueLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInAddStructuralFeatureValueActionAsValueValueEditPart.this), (String) value));
									}
								});
