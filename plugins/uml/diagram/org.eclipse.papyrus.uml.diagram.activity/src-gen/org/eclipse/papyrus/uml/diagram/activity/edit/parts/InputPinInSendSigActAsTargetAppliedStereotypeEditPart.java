 ...
 * @generated
 */
public class InputPinInSendSigActAsTargetAppliedStereotypeEditPart extends AbstractLabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInSendSigActAsTargetAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInSendSigActAsTargetAppliedStereotypeEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_SendSignalActionTargetShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
