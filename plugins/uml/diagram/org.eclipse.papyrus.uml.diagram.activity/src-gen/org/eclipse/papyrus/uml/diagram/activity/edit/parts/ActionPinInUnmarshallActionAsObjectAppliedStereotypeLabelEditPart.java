 ...
 * @generated
 */
public class ActionPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_UnmarshallActionObjectStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ActionPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ActionInputPin_UnmarshallActionObjectShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
