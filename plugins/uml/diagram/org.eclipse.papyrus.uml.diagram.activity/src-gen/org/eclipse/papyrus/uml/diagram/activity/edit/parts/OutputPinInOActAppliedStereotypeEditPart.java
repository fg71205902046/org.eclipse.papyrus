 ...
 * @generated
 */
public class OutputPinInOActAppliedStereotypeEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "OutputPin_OpaqueActionOutputStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInOActAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public OutputPinInOActAppliedStereotypeEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OutputPinInOActAppliedStereotypeEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.OutputPin_OpaqueActionOutputShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
