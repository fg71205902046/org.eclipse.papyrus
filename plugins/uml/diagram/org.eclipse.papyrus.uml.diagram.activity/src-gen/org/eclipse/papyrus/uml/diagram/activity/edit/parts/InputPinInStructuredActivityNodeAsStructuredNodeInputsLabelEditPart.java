 ...
 * @generated
 */
public class InputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_StructuredActivityNodeInputNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInStructuredActivityNodeAsStructuredNodeInputsLabelEditPart.this), (String) value));
									}
								});
