 ...
 * @generated
 */
public class OutputPinInUnmarshallActionAsResultAppliedStereotypeLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "OutputPin_UnmarshallActionResultStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInUnmarshallActionAsResultAppliedStereotypeLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public OutputPinInUnmarshallActionAsResultAppliedStereotypeLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OutputPinInUnmarshallActionAsResultAppliedStereotypeLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.OutputPin_UnmarshallActionResultShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
