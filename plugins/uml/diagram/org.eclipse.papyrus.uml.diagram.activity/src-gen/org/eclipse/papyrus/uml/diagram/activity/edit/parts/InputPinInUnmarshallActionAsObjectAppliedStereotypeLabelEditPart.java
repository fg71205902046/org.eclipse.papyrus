 ...
 * @generated
 */
public class InputPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_UnmarshallActionObjectStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.this), (String) value));
									}
								});
