 ...
 * @generated
 */
public class UnmarshallActionFloatingNameEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "UnmarshallAction_FloatingNameLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.UnmarshallActionFloatingNameEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public UnmarshallActionFloatingNameEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), UnmarshallActionFloatingNameEditPart.this), (String) value));
									}
								});
