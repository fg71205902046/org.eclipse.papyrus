 ...
 * @generated
 */
public class ActionPinInStartClassifierBehaviorActionAsObjectLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_StartClassifierBehaviorActionObjectNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInStartClassifierBehaviorActionAsObjectLabelEditPart.this), (String) value));
									}
								});
