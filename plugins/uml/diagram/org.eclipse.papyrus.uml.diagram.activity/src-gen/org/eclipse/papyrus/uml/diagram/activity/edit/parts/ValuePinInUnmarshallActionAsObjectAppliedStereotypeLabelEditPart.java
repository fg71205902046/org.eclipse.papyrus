 ...
 * @generated
 */
public class ValuePinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_UnmarshallActionObjectStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ValuePinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart.this), (String) value));
									}
								});
