 ...
 * @generated
 */
public class ConstraintAsLocalPostcondBodyEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Constraint_LocalPostconditionBodyLabel";
	 ...
	 * @generated
	 */
	public ConstraintAsLocalPostcondBodyEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ConstraintAsLocalPostcondBodyEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Constraint_LocalPostconditionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
