...
public class FlowFinalNodeAppliedStereotypeEditPart extends AbstractLabelEditPart
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "FlowFinalNode_StereotypeLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), FlowFinalNodeAppliedStereotypeEditPart.this), (String) value));
									}
								});
