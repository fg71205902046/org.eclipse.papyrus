 ...
 * @generated
 */
public class ValuePinInStartObjectBehaviorActionAsObjectLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_StartObjectBehaviorActionObjectNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInStartObjectBehaviorActionAsObjectLabelEditPart.this), (String) value));
									}
								});
