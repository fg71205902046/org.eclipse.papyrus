 ...
 * @generated
 */
public class ValuePinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_StructuredActivityNodeInputValueLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInStructuredActivityNodeAsStructuredNodeInputsValueEditPart.this), (String) value));
									}
								});
