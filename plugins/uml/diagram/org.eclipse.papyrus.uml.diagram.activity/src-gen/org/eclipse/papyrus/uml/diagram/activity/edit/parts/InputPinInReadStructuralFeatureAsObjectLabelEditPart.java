 ...
 * @generated
 */
public class InputPinInReadStructuralFeatureAsObjectLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_ReadStructuralFeatureActionObjectNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInReadStructuralFeatureAsObjectLabelEditPart.this), (String) value));
									}
								});
