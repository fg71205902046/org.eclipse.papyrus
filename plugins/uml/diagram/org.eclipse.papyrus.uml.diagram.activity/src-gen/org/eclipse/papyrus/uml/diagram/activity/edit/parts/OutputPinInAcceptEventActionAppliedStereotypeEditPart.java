 ...
 * @generated
 */
public class OutputPinInAcceptEventActionAppliedStereotypeEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "OutputPin_AcceptEventActionResultStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.OutputPinInAcceptEventActionAppliedStereotypeEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public OutputPinInAcceptEventActionAppliedStereotypeEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OutputPinInAcceptEventActionAppliedStereotypeEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.OutputPin_AcceptEventActionResultShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
