 ...
 * @generated
 */
public class InputPinInUnmarshallActionAsObjectEditPart extends AbstractPinEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_UnmarshallActionObjectShape";
	 ...
	 * @generated
	 */
	public InputPinInUnmarshallActionAsObjectEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		} else if (borderItemEditPart instanceof InputPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
