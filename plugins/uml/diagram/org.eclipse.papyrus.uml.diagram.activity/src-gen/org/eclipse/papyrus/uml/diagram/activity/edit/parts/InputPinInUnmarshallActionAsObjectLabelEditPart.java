 ...
 * @generated
 */
public class InputPinInUnmarshallActionAsObjectLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_UnmarshallActionObjectNameLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.InputPinInUnmarshallActionAsObjectLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public InputPinInUnmarshallActionAsObjectLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInUnmarshallActionAsObjectLabelEditPart.this), (String) value));
									}
								});
