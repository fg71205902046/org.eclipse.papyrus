 ...
 * @generated
 */
public class ValuePinInClearStructuralFeatureActionAsObjectLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_ClearStructuralFeatureActionObjectNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInClearStructuralFeatureActionAsObjectLabelEditPart.this), (String) value));
									}
								});
