 ...
 * @generated
 */
public class InputPinInAddStructuralFeatureValueActionAsValueLabel2EditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_AddStructuralFeatureValueActionValueNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInAddStructuralFeatureValueActionAsValueLabel2EditPart.this), (String) value));
									}
								});
