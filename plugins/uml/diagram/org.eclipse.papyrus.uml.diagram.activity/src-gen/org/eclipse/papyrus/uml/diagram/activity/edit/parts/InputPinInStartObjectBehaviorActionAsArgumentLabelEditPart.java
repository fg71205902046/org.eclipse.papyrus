 ...
 * @generated
 */
public class InputPinInStartObjectBehaviorActionAsArgumentLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_StartObjectBehaviorActionArgumentNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInStartObjectBehaviorActionAsArgumentLabelEditPart.this), (String) value));
									}
								});
