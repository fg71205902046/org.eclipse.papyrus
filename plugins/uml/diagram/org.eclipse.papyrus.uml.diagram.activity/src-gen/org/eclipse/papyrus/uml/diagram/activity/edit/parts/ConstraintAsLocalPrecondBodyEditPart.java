 ...
 * @generated
 */
public class ConstraintAsLocalPrecondBodyEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Constraint_LocalPreconditionBodyLabel";
	 ...
	 * @generated
	 */
	public ConstraintAsLocalPrecondBodyEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ConstraintAsLocalPrecondBodyEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Constraint_LocalPreconditionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
