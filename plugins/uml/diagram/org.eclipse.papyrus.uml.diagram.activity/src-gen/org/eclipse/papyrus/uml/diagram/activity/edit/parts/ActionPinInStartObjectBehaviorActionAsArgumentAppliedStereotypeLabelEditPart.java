 ...
 * @generated
 */
public class ActionPinInStartObjectBehaviorActionAsArgumentAppliedStereotypeLabelEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_StartObjectBehaviorActionArgumentStereotypeLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionPinInStartObjectBehaviorActionAsArgumentAppliedStereotypeLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ActionPinInStartObjectBehaviorActionAsArgumentAppliedStereotypeLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInStartObjectBehaviorActionAsArgumentAppliedStereotypeLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.ActionInputPin_StartObjectBehaviorActionArgumentShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
