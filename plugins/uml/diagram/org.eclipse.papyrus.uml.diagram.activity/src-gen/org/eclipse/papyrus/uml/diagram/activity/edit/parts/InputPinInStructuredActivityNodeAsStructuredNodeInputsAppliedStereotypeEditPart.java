 ...
 * @generated
 */
public class InputPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart
		extends AbstractLabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InputPin_StructuredActivityNodeInputStereotypeLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), InputPinInStructuredActivityNodeAsStructuredNodeInputsAppliedStereotypeEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.InputPin_StructuredActivityNodeInputShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
