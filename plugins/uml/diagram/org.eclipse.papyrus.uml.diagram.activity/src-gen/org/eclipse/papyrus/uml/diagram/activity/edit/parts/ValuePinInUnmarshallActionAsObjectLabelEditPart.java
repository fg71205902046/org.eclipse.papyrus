 ...
 * @generated
 */
public class ValuePinInUnmarshallActionAsObjectLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_UnmarshallActionObjectNameLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInUnmarshallActionAsObjectLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ValuePinInUnmarshallActionAsObjectLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInUnmarshallActionAsObjectLabelEditPart.this), (String) value));
									}
								});
