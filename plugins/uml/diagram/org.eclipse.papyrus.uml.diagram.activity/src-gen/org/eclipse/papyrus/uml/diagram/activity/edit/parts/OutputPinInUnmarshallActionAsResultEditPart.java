 ...
 * @generated
 */
public class OutputPinInUnmarshallActionAsResultEditPart extends AbstractPinEditPart {
	 ...
	 * @generated
	 */
	public OutputPinInUnmarshallActionAsResultEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		...
		} else if (borderItemEditPart instanceof OutputPinInUnmarshallActionAsResultAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
