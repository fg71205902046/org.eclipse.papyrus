 ...
 * @generated
 */
public class ActionPinInUnmarshallActionAsObjectLabelEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_UnmarshallActionObjectNameLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionPinInUnmarshallActionAsObjectLabelEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ActionPinInUnmarshallActionAsObjectLabelEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInUnmarshallActionAsObjectLabelEditPart.this), (String) value));
									}
								});
