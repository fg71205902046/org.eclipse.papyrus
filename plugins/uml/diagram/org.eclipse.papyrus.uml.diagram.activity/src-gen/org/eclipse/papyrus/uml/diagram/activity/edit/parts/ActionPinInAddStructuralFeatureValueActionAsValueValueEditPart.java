 ...
 * @generated
 */
public class ActionPinInAddStructuralFeatureValueActionAsValueValueEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_AddStructuralFeatureValueActionValueValueLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInAddStructuralFeatureValueActionAsValueValueEditPart.this), (String) value));
									}
								});
