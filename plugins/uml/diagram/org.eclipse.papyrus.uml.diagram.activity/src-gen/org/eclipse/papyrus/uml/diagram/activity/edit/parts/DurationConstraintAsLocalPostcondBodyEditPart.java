 ...
 * @generated
 */
public class DurationConstraintAsLocalPostcondBodyEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "DurationConstraint_LocalPostconditionBodyLabel";
	 ...
	 * @generated
	 */
	public DurationConstraintAsLocalPostcondBodyEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), DurationConstraintAsLocalPostcondBodyEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.DurationConstraint_LocalPostconditionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
