 ...
 * @generated
 */
public class ActionPinInUnmarshallActionAsObjectValueEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_UnmarshallActionObjectValueLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ActionPinInUnmarshallActionAsObjectValueEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ActionPinInUnmarshallActionAsObjectValueEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ActionPinInUnmarshallActionAsObjectValueEditPart.this), (String) value));
									}
								});
