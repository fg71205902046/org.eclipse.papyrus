 ...
 * @generated
 */
public class OutputPinInReadExtentActionLabelEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "OutputPin_ReadExtentActionResultNameLabel";
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), OutputPinInReadExtentActionLabelEditPart.this), (String) value));
									}
								});
