 ...
 * @generated
 */
public class ValuePinInUnmarshallActionAsObjectValueEditPart extends
	 ...
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_UnmarshallActionObjectValueLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInUnmarshallActionAsObjectValueEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ValuePinInUnmarshallActionAsObjectValueEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInUnmarshallActionAsObjectValueEditPart.this), (String) value));
									}
								});
