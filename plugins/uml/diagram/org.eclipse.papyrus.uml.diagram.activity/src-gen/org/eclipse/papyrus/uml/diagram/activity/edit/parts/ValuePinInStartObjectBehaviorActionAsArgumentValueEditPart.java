 ...
 * @generated
 */
public class ValuePinInStartObjectBehaviorActionAsArgumentValueEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ValuePin_StartObjectBehaviorActionArgumentValueLabel";
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.activity.edit.parts.ValuePinInStartObjectBehaviorActionAsArgumentValueEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public ValuePinInStartObjectBehaviorActionAsArgumentValueEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), ValuePinInStartObjectBehaviorActionAsArgumentValueEditPart.this), (String) value));
									}
								});
