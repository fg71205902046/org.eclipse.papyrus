 ...
 * @generated
 */
public class ActionPinInUnmarshallActionAsObjectEditPart extends AbstractPinEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "ActionInputPin_UnmarshallActionObjectShape";
	 ...
	 * @generated
	 */
	public ActionPinInUnmarshallActionAsObjectEditPart(View view) {
		super(view);
	}
	...
	protected void addBorderItem(IFigure borderItemContainer, IBorderItemEditPart borderItemEditPart) {
		if (borderItemEditPart instanceof ActionPinInUnmarshallActionAsObjectLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ActionPinInUnmarshallActionAsObjectValueEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else if (borderItemEditPart instanceof ActionPinInUnmarshallActionAsObjectAppliedStereotypeLabelEditPart) {
			IBorderItemLocator locator = new ExternalLabelPositionLocator(getMainFigure());
			borderItemContainer.add(borderItemEditPart.getFigure(), locator);
		} else {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(UMLVisualIDRegistry.getType(ActionPinInUnmarshallActionAsObjectLabelEditPart.VISUAL_ID));
	}
