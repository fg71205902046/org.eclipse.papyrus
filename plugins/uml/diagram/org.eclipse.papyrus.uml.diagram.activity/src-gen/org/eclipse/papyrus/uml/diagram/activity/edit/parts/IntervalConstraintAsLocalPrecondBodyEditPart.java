 ...
 * @generated
 */
public class IntervalConstraintAsLocalPrecondBodyEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "IntervalConstraint_LocalPreconditionBodyLabel";
	 ...
	 * @generated
	 */
	public IntervalConstraintAsLocalPrecondBodyEditPart(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), IntervalConstraintAsLocalPrecondBodyEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.IntervalConstraint_LocalPreconditionShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
