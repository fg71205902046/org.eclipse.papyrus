 ...
 * @generated
 */
public class StateDefinitionLabelEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Node_StateDefinitionNameLabel";
	 ...
	 * @generated
	 */
	public StateDefinitionLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														StateDefinitionLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Node_StateDefinitionShape, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
