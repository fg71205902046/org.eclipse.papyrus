 ...
 * @generated
 */
public class TimeConstraintSpecificationEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.timing.edit.parts.TimeConstraintSpecificationEditPart.VISUAL_ID),
				new Point(0, 0));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																TimeConstraintSpecificationEditPart.this),
														(String) value));
									}
								});
