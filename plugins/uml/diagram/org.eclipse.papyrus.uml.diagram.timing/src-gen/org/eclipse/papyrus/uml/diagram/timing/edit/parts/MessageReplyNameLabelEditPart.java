 ...
 * @generated
 */
public class MessageReplyNameLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Message_ReplyNameLabel";
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageReplyNameLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public MessageReplyNameLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														MessageReplyNameLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Message_ReplyEdge, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
