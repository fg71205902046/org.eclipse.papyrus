 ...
 * @generated
 */
public class CompactLifelineNameEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Lifeline_CompactNameLabel";
	 ...
	 * @generated
	 */
	public CompactLifelineNameEditPart(View view) {
		super(view);
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), CompactLifelineNameEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Lifeline_CompactShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
