 ...
 * @generated
 */
public class FullStateInvariantAppliedStereotypeEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "StateInvariant_FullStereotypeLabel";
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.timing.edit.parts.FullStateInvariantAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public FullStateInvariantAppliedStereotypeEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														FullStateInvariantAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.StateInvariant_FullShape, getParserElement(), this,
					VISUAL_ID);
		}
		return parser;
	}
