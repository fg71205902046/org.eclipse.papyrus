 ...
 * @generated
 */
public class MessageSyncNameLabelEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageSyncNameLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public MessageSyncNameLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														MessageSyncNameLabelEditPart.this), (String) value));
									}
								});
