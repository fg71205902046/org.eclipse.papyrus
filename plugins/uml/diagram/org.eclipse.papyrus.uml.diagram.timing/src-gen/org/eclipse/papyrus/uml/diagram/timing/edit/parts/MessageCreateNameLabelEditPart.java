 ...
 * @generated
 */
public class MessageCreateNameLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Message_CreateNameLabel";
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageCreateNameLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public MessageCreateNameLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														MessageCreateNameLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Message_CreateEdge, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
