 ...
 * @generated
 */
public class FullLifelineNameEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Lifeline_FullNameLabel";
	 ...
	 * @generated
	 */
	public FullLifelineNameEditPart(View view) {
		super(view);
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), FullLifelineNameEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.Lifeline_FullShape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
