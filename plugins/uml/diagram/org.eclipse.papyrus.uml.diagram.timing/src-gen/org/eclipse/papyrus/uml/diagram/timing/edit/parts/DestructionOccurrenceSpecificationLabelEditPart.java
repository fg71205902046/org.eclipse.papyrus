 ...
 * @generated
 */
public class DestructionOccurrenceSpecificationLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "DestructionOccurrenceSpecification_NameLabel";
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.timing.edit.parts.DestructionOccurrenceSpecificationLabelEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public DestructionOccurrenceSpecificationLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														DestructionOccurrenceSpecificationLabelEditPart.this),
												(String) value));
									}
								});
