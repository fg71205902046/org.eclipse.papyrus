 ...
 * @generated
 */
public class CompactStateInvariantNameEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "StateInvariant_CompactNameLabel";
	 ...
	 * @generated
	 */
	public CompactStateInvariantNameEditPart(View view) {
		super(view);
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																CompactStateInvariantNameEditPart.this),
														(String) value));
									}
								});
