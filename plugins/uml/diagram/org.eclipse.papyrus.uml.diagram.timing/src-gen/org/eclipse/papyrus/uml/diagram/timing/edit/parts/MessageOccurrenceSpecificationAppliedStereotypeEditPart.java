 ...
 * @generated
 */
public class MessageOccurrenceSpecificationAppliedStereotypeEditPart extends AbstractLabelEditPart
		implements ITextAwareEditPart, IBorderItemEditPart {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "MessageOccurrenceSpecification_StereotypeLabel";
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageOccurrenceSpecificationAppliedStereotypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public MessageOccurrenceSpecificationAppliedStereotypeEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														MessageOccurrenceSpecificationAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.MessageOccurrenceSpecification_Shape, getParserElement(),
					this, VISUAL_ID);
		}
		return parser;
	}
