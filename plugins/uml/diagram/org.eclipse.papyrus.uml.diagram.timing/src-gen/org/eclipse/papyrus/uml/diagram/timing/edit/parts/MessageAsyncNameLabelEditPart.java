 ...
 * @generated
 */
public class MessageAsyncNameLabelEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Message_AsynchNameLabel";
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.timing.edit.parts.MessageAsyncNameLabelEditPart.VISUAL_ID),
				new Point(0, -10));
	}
	 ...
	 * @generated
	 */
	public MessageAsyncNameLabelEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(
												parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(),
														MessageAsyncNameLabelEditPart.this), (String) value));
									}
								});
