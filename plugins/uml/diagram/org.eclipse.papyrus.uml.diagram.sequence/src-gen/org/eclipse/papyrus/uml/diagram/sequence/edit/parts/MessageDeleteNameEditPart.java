 ...
 * @generated
 */
public class MessageDeleteNameEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageDeleteNameEditPart.VISUAL_ID),
				new Point(1, -13));
	}
	 ...
	 * @generated
	 */
	public MessageDeleteNameEditPart(View view) {
		super(view);
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), MessageDeleteNameEditPart.this), (String) value));
									}
								});
