 ...
 * @generated
 */
public class MessageCreateNameEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageCreateNameEditPart.VISUAL_ID),
				new Point(1, -13));
	}
	 ...
	 * @generated
	 */
	public MessageCreateNameEditPart(View view) {
		super(view);
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), MessageCreateNameEditPart.this), (String) value));
									}
								});
