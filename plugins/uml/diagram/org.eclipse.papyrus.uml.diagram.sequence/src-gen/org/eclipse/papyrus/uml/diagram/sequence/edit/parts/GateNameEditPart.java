 ...
 * @generated
 */
public class GateNameEditPart extends FloatingLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry
						.getType(org.eclipse.papyrus.uml.diagram.sequence.edit.parts.GateNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(), GateNameEditPart.this),
												(String) value));
									}
								});
	...
	/**
	 * @see org.eclipse.papyrus.infra.gmfdiag.common.editpart.PapyrusLabelEditPart#refresh()
	 *
	 */
	@Override
	public void refresh() {
