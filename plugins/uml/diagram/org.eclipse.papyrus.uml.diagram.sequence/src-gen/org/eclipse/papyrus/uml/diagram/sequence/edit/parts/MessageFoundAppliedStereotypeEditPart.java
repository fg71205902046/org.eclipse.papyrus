 ...
 * @generated
 */
public class MessageFoundAppliedStereotypeEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Message_FoundStereotypeLabel";
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageFoundAppliedStereotypeEditPart.VISUAL_ID),
				new Point(1, -33));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																MessageFoundAppliedStereotypeEditPart.this),
														(String) value));
									}
								});
