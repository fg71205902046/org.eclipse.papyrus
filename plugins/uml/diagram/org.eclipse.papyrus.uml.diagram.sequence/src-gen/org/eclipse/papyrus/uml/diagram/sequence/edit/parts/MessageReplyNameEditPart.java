 ...
 * @generated
 */
public class MessageReplyNameEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageReplyNameEditPart.VISUAL_ID),
				new Point(1, -13));
	}
	 ...
	 * @generated
	 */
	public MessageReplyNameEditPart(View view) {
		super(view);
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), MessageReplyNameEditPart.this), (String) value));
									}
								});
