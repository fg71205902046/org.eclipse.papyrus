 ...
 * @generated
 */
public class ConstraintContextAppliedStereotypeEditPart extends PapyrusLabelEditPart
	 ...
	 * @generated
	 */
	public ConstraintContextAppliedStereotypeEditPart(View view) {
		super(view);
	}
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														ConstraintContextAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
