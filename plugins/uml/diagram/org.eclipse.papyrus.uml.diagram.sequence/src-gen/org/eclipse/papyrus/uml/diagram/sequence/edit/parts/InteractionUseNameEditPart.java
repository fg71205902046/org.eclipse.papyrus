 ...
 * @generated
 */
public class InteractionUseNameEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InteractionUse_NameLabel";
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), InteractionUseNameEditPart.this), (String) value));
									}
								});
