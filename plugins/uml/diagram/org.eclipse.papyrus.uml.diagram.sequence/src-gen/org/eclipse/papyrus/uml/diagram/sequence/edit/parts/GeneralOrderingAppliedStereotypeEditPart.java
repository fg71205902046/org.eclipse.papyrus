 ...
 * @generated
 */
public class GeneralOrderingAppliedStereotypeEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "GeneralOrdering_StereotypeLabel";
									...
									public void run() {
										setResult(parser.isValidEditString(
												ParserUtil.getParserAdapter(getParserElement(),
														GeneralOrderingAppliedStereotypeEditPart.this),
												(String) value));
									}
								});
