 ...
 * @generated
 */
public class MessageAsyncNameEditPart extends PapyrusLabelEditPart
	...
	static {
		registerSnapBackPosition(
				UMLVisualIDRegistry.getType(
						org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageAsyncNameEditPart.VISUAL_ID),
				new Point(1, -13));
	}
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), MessageAsyncNameEditPart.this), (String) value));
									}
								});
