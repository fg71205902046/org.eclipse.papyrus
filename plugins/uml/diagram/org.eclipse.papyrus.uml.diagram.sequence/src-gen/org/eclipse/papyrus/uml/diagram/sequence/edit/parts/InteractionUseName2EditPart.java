 ...
 * @generated
 */
public class InteractionUseName2EditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "InteractionUse_TypeLabel";
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), InteractionUseName2EditPart.this), (String) value));
									}
								});
