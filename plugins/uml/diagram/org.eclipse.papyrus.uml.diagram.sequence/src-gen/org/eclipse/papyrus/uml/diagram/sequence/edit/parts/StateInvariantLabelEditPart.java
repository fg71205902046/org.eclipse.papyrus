 ...
 * @generated
 */
public class StateInvariantLabelEditPart extends PapyrusCompartmentEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "StateInvariant_ConstraintLabel";
								...
								.runExclusive(new RunnableWithResult.Impl<>() {
									...
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(
												getParserElement(), StateInvariantLabelEditPart.this), (String) value));
									}
								});
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ParserUtil.getParser(UMLElementTypes.StateInvariant_Shape, getParserElement(), this, VISUAL_ID);
		}
		return parser;
	}
