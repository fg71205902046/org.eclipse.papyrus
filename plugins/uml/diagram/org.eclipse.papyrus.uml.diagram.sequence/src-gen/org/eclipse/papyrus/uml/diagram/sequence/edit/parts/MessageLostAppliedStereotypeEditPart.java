 ...
 * @generated
 */
public class MessageLostAppliedStereotypeEditPart extends PapyrusLabelEditPart
		implements ITextAwareEditPart, IControlParserForDirectEdit, ILabelRoleProvider {

	/**
	 * @generated
	 */
	public static final String VISUAL_ID = "Message_LostStereotypeLabel";
	...
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(
				org.eclipse.papyrus.uml.diagram.sequence.edit.parts.MessageLostAppliedStereotypeEditPart.VISUAL_ID),
				new Point(1, -33));
	}
										...
										setResult(
												parser.isValidEditString(
														ParserUtil.getParserAdapter(getParserElement(),
																MessageLostAppliedStereotypeEditPart.this),
														(String) value));
									}
								});
