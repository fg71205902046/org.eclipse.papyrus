 ...
 * @generated
 */
public class TimeObservationStereotypeLabelEditPartCN extends PapyrusLabelEditPart
	 ...
	 */
	static {
		registerSnapBackPosition(UMLVisualIDRegistry.getType(org.eclipse.papyrus.uml.diagram.communication.edit.parts.TimeObservationStereotypeLabelEditPartCN.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public TimeObservationStereotypeLabelEditPartCN(View view) {
		super(view);
	}
					...
					try {
						IParserEditStatus valid = (IParserEditStatus) getEditingDomain().runExclusive(
								new RunnableWithResult.Impl<>() {
									...
									@Override
									public void run() {
										setResult(parser.isValidEditString(ParserUtil.getParserAdapter(getParserElement(), TimeObservationStereotypeLabelEditPartCN.this), (String) value));
									}
								});
